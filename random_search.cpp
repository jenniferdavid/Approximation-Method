...
float calculateLR(Eigen::MatrixXd VMatrix, Eigen::MatrixXd PMatrix, bool sol) //calculate LR from V and PMatrix
   {
...
int main(int argc, const char* argv[])
{
    ...
    if (isValid(vMatInv))
        {
            costValue = calculateLR(vMat, vMatInv,sol);
